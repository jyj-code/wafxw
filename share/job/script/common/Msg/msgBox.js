...
function MsgBox(s) {
    ...
    function readyMsgBox() {
        if (s != null){
            if (s.imghref != null) paras.imghref = s.imghref; else paras.imghref = "script/common/Msg/images/";
        ...
        else paras = { imghref: "script/common/Msg/images/", waitImg: "loader.gif", bgImg: "qzonebg.gif" };
